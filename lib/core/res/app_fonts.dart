...
// class AppFonts {
//   static const TextTheme lightAppBarTheme = TextTheme(
...
//       lightScreenHeadingTextStyle.copyWith(
//     color: AppColors.darkOnPrimaryColor,
//   );

//   static final TextStyle darkScreenTaskNameTextStyle =
//       lightScreenTaskNameTextStyle.copyWith(
//     color: AppColors.darkOnPrimaryColor,
//   );

//   static const TextStyle darkScreenTaskDurationTextStyle =
//       lightScreenTaskDurationTextStyle;
...
//   static final TextStyle darkAppbarTitleTextStyle = lightAppbarTitleTextStyle.copyWith(
//     color: AppColors.darkOnPrimaryColor,
//   );

//   static const TextStyle lightAppbarSubtitleTextStyle = TextStyle(
//     //  fontFamily: GoogleFonts.vollkorn().fontFamily,
...
//   static final TextStyle darkAppbarSubtitleTextStyle = lightAppbarTitleTextStyle.copyWith(
//     color: AppColors.darkOnPrimaryColor,
//   );
...
//         fontWeight: boldFont,
//       );
//   static TextStyle dialogCancelBtn() => const TextStyle(
//         //    fontFamily: GoogleFonts.vollkorn().fontFamily,
//         color: AppColors.appWhite,
//         fontSize: 16,
//         fontWeight: semiBoldFont,
//       );
//   static TextStyle dialogConfirmBtn() => const TextStyle(
//         //  fontFamily: GoogleFonts.vollkorn().fontFamily,
//         color: AppColors.appWhite,
//         fontSize: 16,
//         fontWeight: semiBoldFont,
